...
const Projects = ()=>{
    return(
        <div className="project">
            ...
            <ProjectCard status={"Done"} img="./pr3.svg" title={"Pokemon Classifier"} description={"Sorting algorithm visualizer built with react.js. Implemented MergeSort, Bubble Sort, Selection Sort."} link={"https://github.com/tapan2930/sort-algorithm-visuliazer-react"} />
            <ProjectCard status={"Done"} img="./pr4.png" title={"Amazon Reciew Scrapper CLI Application"} description={"Sorting algorithm visualizer built with react.js. Implemented MergeSort, Bubble Sort, Selection Sort."} link={"https://github.com/tapan2930/sort-algorithm-visuliazer-react"} />
            </div>
